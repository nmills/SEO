    ...
    */
    ...
    function widget( $args, $instance ) {
        ...
        if (!empty($instance['facebook'])) {
            ...
            $output .= '<a href="' . $instance['facebook'] . '" target="_blank">';
            $output .= '<svg class="icon"><title>' . __('Facebook') . '</title><use xlink:href="#facebook"></use></svg>';
            $output .= '</a>';
            $output .= '</li>';
        }
        if (!empty($instance['twitter'])) {
            $output .= '<li class="twitter-link">';
            $output .= '<a href="' . $instance['twitter'] . '" target="_blank">';
            $output .= '<svg class="icon"><title>' . __('Twitter') . '</title><use xlink:href="#twitter"></use></svg>';
            $output .= '</a>';
            $output .= '</li>';
        }
        if (!empty($instance['googleplus'])) {
            $output .= '<li class="googleplus-link">';
            $output .= '<a href="' . $instance['googleplus'] . '" target="_blank">';
            $output .= '<svg class="icon"><title>' . __('Google+') . '</title><use xlink:href="#googleplus"></use></svg>';
            $output .= '</a>';
            $output .= '</li>';
        }
        if (!empty($instance['instagram'])) {
            $output .= '<li class="instagram-link">';
            $output .= '<a href="' . $instance['instagram'] . '" target="_blank">';
            $output .= '<svg class="icon"><title>' . __('Instagram') . '</title><use xlink:href="#instagram"></use></svg>';
            $output .= '</a>';
            $output .= '</li>';
        }
        if (!empty($instance['flickr'])) {
            $output .= '<li class="flickr-link">';
            $output .= '<a href="' . $instance['flickr'] . '" target="_blank">';
            $output .= '<svg class="icon"><title>' . __('Flickr') . '</title><use xlink:href="#flickr"></use></svg>';
            $output .= '</a>';
            $output .= '</li>';
        }
        if (!empty($instance['pinterest'])) {
            $output .= '<li class="pinterest-link">';
            $output .= '<a href="' . $instance['pinterest'] . '" target="_blank">';
            $output .= '<svg class="icon"><title>' . __('Pinterest') . '</title><use xlink:href="#pinterest"></use></svg>';
            $output .= '</a>';
            $output .= '</li>';
        }
        if (!empty($instance['linkedin'])) {
            $output .= '<li class="linkedin-link">';
            $output .= '<a href="' . $instance['linkedin'] . '" target="_blank">';
            $output .= '<svg class="icon"><title>' . __('LinkedIn') . '</title><use xlink:href="#linkedin"></use></svg>';
            $output .= '</a>';
            $output .= '</li>';
        }
        if (!empty($instance['youtube'])) {
            $output .= '<li class="youtube-link">';
            $output .= '<a href="' . $instance['youtube'] . '" target="_blank">';
            $output .= '<svg class="icon"><title>' . __('Youtube') . '</title><use xlink:href="#youtube"></use></svg>';
            $output .= '</a>';
            $output .= '</li>';
        }
        if (!empty($instance['email'])) {
            $output .= '<li class="email-link">';
            $output .= '<a href="mailto:' . $instance['email'] . '" target="_blank">';
            $output .= '<svg class="icon"><title>' . __('Email') . '</title><use xlink:href="#envelope"></use></svg>';
            $output .= '</a>';
            $output .= '</li>';
        }
        $output .= '</ul>';
