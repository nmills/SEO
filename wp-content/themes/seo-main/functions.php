...
class BSDStarterSite extends TimberSite {
  ...
  function add_styles_and_scripts() {
    ...
    if (!is_admin()) {
      ...
      wp_enqueue_script( 'circular', get_stylesheet_directory_uri() . '/src/js/vendor/jquery.circular.js', array(), '1.0.0', false );
      wp_enqueue_script( 'svg', get_stylesheet_directory_uri() . '/src/js/vendor/jquery.drawsvg.min.js', array(), '1.1.0', false );
