...
class SEOSite extends TimberSite
{
...
*/
function seo_get_sidebar_slug($post)
{
...
require_once(get_template_directory() . '/includes/seo_editor_styles.php');

// Custom Shortcodes
require_once(get_template_directory() . '/includes/seo_shortcodes.php');
