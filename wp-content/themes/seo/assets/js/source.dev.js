...
!function(a,b,c){
function d(a){
var b={},d=/^jQuery\d+$/;return c.each(a.attributes,function(a,c){
c.specified&&!d.test(c.name)&&(b[c.name]=c.value);
}),b;
}function e(a,b){
var d=this,e=c(d);if(d.value==e.attr('placeholder')&&e.hasClass('placeholder'))if(e.data('placeholder-password')){
...
var a=void 0,b=this,f=c(b),g=this.id;if(''==b.value){
if('password'==b.type){
...
}var h=void 0,i=void 0,j='[object OperaMini]'==Object.prototype.toString.call(a.operamini),k='placeholder'in b.createElement('input')&&!j,l='placeholder'in b.createElement('textarea')&&!j,m=c.fn,n=c.valHooks,o=c.propHooks;k&&l?(i=m.placeholder=function(){
return this;
...
var b=c(a),d=b.data('placeholder-password');return d?d[0].value:b.data('placeholder-enabled')&&b.hasClass('placeholder')?'':a.value;
},set:function set(a,b){
var d=c(a),h=d.data('placeholder-password');return h?h[0].value=b:d.data('placeholder-enabled')?(''==b?(a.value=b,a!=g()&&f.call(a)):d.hasClass('placeholder')?e.call(a,!0,b)||(a.value=b):a.value=b,d):a.value=b;
